...
\titleformat*{\section}{\sffamily\LARGE\bfseries\color{battleshipgrey}}
\titleformat*{\subsection}{\sffamily\Large\bfseries\color{battleshipgrey}}
\titleformat*{\subsubsection}{\sffamily\large\bfseries\color{battleshipgrey}}
...
\newpage
\input{\Path/VLSI/00-VLSI}

\part{Entwurf eingebetteter Systeme}
\newpage
%\input{../Mikrorechner/Skript/00-Mikrorechner}
...
\part{Appendix}
\newpage
\input{\Path/Appendix/00-Appendix}
\end{document}
