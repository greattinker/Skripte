...
\subsection{Synchrones Reset}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[page=52, width=0.65\linewidth, trim=30mm 27mm 27mm 120mm, clip]{\Path/resources/Vorlesung/VLSI/03_Automaten.pdf}
	\end{center}
...
\subsection{Asynchrones Reset}
	...
	\end{itemize}
	\begin{center}
		\includegraphics[page=54, width=0.65\linewidth, trim=30mm 27mm 27mm 120mm, clip]{\Path/resources/Vorlesung/VLSI/03_Automaten.pdf}
	\end{center}
